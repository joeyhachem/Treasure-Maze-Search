...
In the same directory, run the following command: 
	`python .\Bfs-A-Star-Search.py y_start_coord x_start_coord y_treasure_coord x_treasure_coord`
...
How to run:
In the same directory, run the following command: 
	`python .\DfsMaze.py y_start_coord x_start_coord y_treasure_coord x_treasure_coord`
...
In the same directory, run the following command (note that there is an 'a' at the end to enable A* Search): 
	`python .\Bfs-A-Star-Search.py y_start_coord x_start_coord y_treasure_coord x_treasure_coord a`
